...
import { Clock, CheckCircle2, XCircle, ShieldCheck, ClipboardCheck, ArrowRight, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react';
import FilterTabs from './FilterTabs';

/** Thanh phân trang tông dark-tím, đồng bộ với trang duyệt hồ sơ Admin. */
function ReviewPagination({ page, totalPages, totalElements, currentCount, unit = 'hồ sơ', onPage, loading }) {
