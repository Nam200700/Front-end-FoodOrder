      ...
      {error ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
          {filteredList.map((res) => (
            ...
            >
              {/* Ảnh quán + nút bỏ yêu thích + tag nổi */}
              <div className="relative h-40 w-full overflow-hidden">
                ...
                <div className="absolute bottom-3 left-3 flex gap-1.5">
                  {res.tags.map((tag, i) => (
                    <span key={i} className="text-[10px] bg-black/65 text-white px-2 py-0.5 rounded font-extrabold">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-3 text-xs text-md-on-surface-variant font-semibold mt-2">
                ...
                <span className="inline-block mt-3 text-[11px] font-extrabold bg-[#E8F5E9] text-[#2E7D32] px-2.5 py-1 rounded">
                  {res.shipping}
                </span>
              </div>
            </div>
